    ...
    },
    {
        ...
        context: {
            lastCommit: `squashed commit title with custom config (#9)                     \n\n` +
                `* fix(lambdas): #221 solved DB timeout issue \r\n` +
                `* feat(lambdas): #232 added reporting feature \r\n` +
            ...
            changes: [
                {
                    ...
                    originalCommit: 'fix(lambdas): #221 solved DB timeout issue'
                },
                {
                    type: 'feat',
                    ...
                    originalCommit: 'feat(lambdas): #232 added reporting feature'
                },
                {
                    type: 'fix',
                    releaseAssociated: 'patch',
